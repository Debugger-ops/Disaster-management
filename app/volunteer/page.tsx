...
import { Users, Heart, MapPin, Clock, Phone, Mail, User, AlertTriangle } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="volunteer-form">
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    placeholder="e.g., First Aid, Medical Training, Construction, IT Support..."
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    placeholder="Tell us about any relevant volunteer or emergency response experience..."
                    className="form-textarea"
                  />
                </div>
